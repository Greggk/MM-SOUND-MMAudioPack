/*
        ...
        MMioFlac.WPI, containing the MMioFlac program
        (C) VOICE 
*/
...
DO UNTIL (lines(InName)=0)
  linex=linein(InName)
  If POS('PACKAGEID="Netlabs\MMioFlac',linex)>0 then Do
    linex=linex||version||'"'
  end
...
/* Package 1 MMioFlac */
warpindir"\wic.exe "pkgname||fileversion" -a 1 -r -cMMioFlac * -s "||pkgname||fileversion||".wis"
